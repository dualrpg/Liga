...
class TablaLesiones:
    def __init__(self, root, div) -> None:
        ...
        self.table.heading("c3", text="Gravedad")
        self.table.heading("c4", text="Duración")
    ...
    def my_display(self, n, division):
        ...
        gen = lesiones().get_lesiones_division(division, n, self.limit)
        next_gen = lesiones().get_lesiones_division(
            division, n + self.limit, self.limit
        )
