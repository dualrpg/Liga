...
class TablaGoles:
    def __init__(self, root, div) -> None:
        ...
        self.table.heading("c3", text="Minuto")
        self.table.heading("c4", text="Propia")
    ...
    def my_display(self, n, division):
        ...
        gen = goles().get_goles_division(division, n, self.limit)
        next_gen = goles().get_goles_division(division, n + self.limit, self.limit)
